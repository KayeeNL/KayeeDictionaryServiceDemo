...
try {
    ...
    & $mkcert -install
    & $mkcert "*.kayeedictionaryservicedemo.localhost"
}
catch {
...
if ($Topology -ne "xp0") {
  Add-HostsEntry "cd.kayeedictionaryservicedemo.localhost"
}
Add-HostsEntry "cm.kayeedictionaryservicedemo.localhost"
Add-HostsEntry "id.kayeedictionaryservicedemo.localhost"
Add-HostsEntry "www.kayeedictionaryservicedemo.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.kayeedictionaryservicedemo.localhost"

    if ($Topology -ne "xp0") {
      # CD_HOST
      Set-EnvFileVariable "CD_HOST" -Value "cd.kayeedictionaryservicedemo.localhost"
    }


    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.kayeedictionaryservicedemo.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.kayeedictionaryservicedemo.localhost"
